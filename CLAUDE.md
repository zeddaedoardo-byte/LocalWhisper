...
- Modello default: Whisper Large V3 Turbo ggml in `~/Library/Application Support/LocalWhisper/Models/ggml-large-v3-turbo.bin`. Il modello NON deve stare in iCloud Drive.
...
# Build, download whisper.cpp e download modello Large V3 Turbo
...
- Non tornare da Large V3 Turbo al Large V3 normale senza richiesta esplicita.
...
- Non spostare il modello `ggml-large-v3-turbo.bin` dentro iCloud Drive: il lazy-load fa esplodere il cold start.
