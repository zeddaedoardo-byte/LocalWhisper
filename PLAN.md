...
## Obiettivo
Replicare il flusso essenziale di WhisperFlow in locale: Control hold push-to-talk, registrazione microfono, trascrizione offline con Whisper Large V3 Turbo su Apple Silicon (Metal), copia in clipboard e paste nell'app attiva.
...
- [x] whisper.cpp (via whisper-server persistente) trascrive con `Models/ggml-large-v3-turbo.bin` su Metal.
...
- [x] Scaricare Whisper Large V3 Turbo ggml.
...
- [ ] Provare Core ML encoder per Large V3 Turbo (richiede encoder + WHISPER_COREML=1).
